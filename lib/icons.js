...
//   2. renderIcon(name, attrs) — Codex-Sprite-API gemäß Spec §4.5. Gibt ein
...
// Kanonische Sprite-Symbole gemäß Spec §4.2 (Codex-Set, 30 Symbole; assets/icons.svg
...
const CODEX_SPRITE_NAMES = new Set([
  ...
  'edit', 'quote', 'zap', 'play', 'message-square', 'list', 'target',
...
export function renderIcon(name, attrs = {}) {
  if (typeof document === 'undefined') {
    // Stiller No-Op außerhalb des DOM (z.B. SSR/Node ohne jsdom).
    return null;
  }
  ...
  // Übrige Attribute durchreichen (außer den oben behandelten Keys).
